    ...
    if (result['action'] == 'rescan') {
      ...
      setState(() {
        ...
        if (!_isEdit && _usernameCtrl.text.isEmpty) {
           ...
           _passwordCtrl.text = scannedId; // Default password same as ID
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Sistem mendeteksi data dari kartu eksternal. ID ini akan digunakan sebagai identitas musyrif & username login.',
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  if (widget.jabatan.isNotEmpty) _infoRow('Jabatan', widget.jabatan),
